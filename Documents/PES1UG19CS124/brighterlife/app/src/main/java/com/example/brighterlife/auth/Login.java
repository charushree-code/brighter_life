package com.example.brighterlife.auth;
...
import com.example.brighterlife.MainActivity;
...
public class Login extends AppCompatActivity {
        ...
        loginNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fAuth.getCurrentUser().isAnonymous()){
                    ...
                    fStore.collection("Journal").document(user.getUid()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
    ...
    private void showWarning() {
        final AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setMessage("Linking Existing Account Will delete all the temp pages. Create New Account To Save them.")
